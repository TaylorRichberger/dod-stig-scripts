my $id = 'V-38647';
my $title = 'The system default umask in /etc/profile must be 077.';
my $severity = 'low';
...
my $fix = 'To ensure the default umask controlled by "/etc/profile" is set properly, add or correct the "umask" setting in "/etc/profile" to read as follows: umask 077';
my $autotest = 0;
my $autofix = 0;
