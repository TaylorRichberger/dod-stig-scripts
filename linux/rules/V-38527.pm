my $id = 'V-38527';
my $title = 'The audit system must be configured to audit all attempts to alter system time through clock_settime.';
my $severity = 'low';
